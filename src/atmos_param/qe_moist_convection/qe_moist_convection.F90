...
10     call close_file(unit)
  ...
  subroutine qe_moist_convection (dt, Tin, qin, p_full, p_half, coldT, &
                                  ...
                                  kLZBs, plzbs, plcls, CAPE, CIN, invtau_q_relaxation, &
    ...
    real   , intent(out), dimension(:,:)   :: rain, snow, kLZBs, plzbs, plcls, CAPE, CIN
    ...
    call SBM_convection_scheme(dt, Tin, qin, p_full, p_half, rain, snow, &
         deltaT, deltaq, kLZBs, plzbs, plcls, CAPE, CIN, invtau_q_relaxation,           &
  ...
  subroutine SBM_convection_scheme(dt, Tin, qin, p_full, p_half, rain,  snow, &
       deltaT, deltaq, kLZBs, plzbs, plcls, CAPE, CIN, invtau_q_relaxation, invtau_t_relaxation,&
    ...
    real, intent(out), dimension(:,:)      :: invtau_q_relaxation, invtau_t_relaxation
    real, intent(out), dimension(:,:)      :: kLZBs, plzbs, plcls
    ...
    real                                   :: cape_parcel, cin_parcel, Pq_parcel, Pt_parcel, plzb, plcl
    ...
    do i=1, size(Tin, 1)
       do j=1, size(Tin, 2)
          ...
          call CAPE_calculation(k_surface, p_full(i,j,:), p_half(i,j,:), &
               ...
               cape_parcel, cin_parcel, val_min, val_max, lcl_temp_table, plzb, plcl)
  ...
  subroutine CAPE_calculation(k_surface, p_full, p_half, Tin, rin, kLZB, &
       Tp, rp, CAPE, CIN, val_min, val_max, lcl_temp_table, pLZB, pLCL)
    ...
    real, intent(out)                    :: CAPE, CIN, plzb, pLCL
