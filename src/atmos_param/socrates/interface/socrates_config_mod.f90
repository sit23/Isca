...
!   control%l_hfc134a        = .FALSE.
  ...
  logical :: inc_cia=.FALSE. !control for including collision induced absorption
  ...
  NAMELIST/socrates_rad_nml/ stellar_constant, tidally_locked, lw_spectral_filename, lw_hires_spectral_filename, &
                             ...
                             frierson_solar_rad, del_sol, del_sw, do_scm_ozone, scm_ozone, inc_cia
