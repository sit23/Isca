...
exp = Experiment('dry_giant_planet_column_60_levels_with_conv_with_diff_mk2_with_rad_with_int_with_sun', codebase=cb)

# exp.inputfiles = [os.path.join(base_dir,'input/jupiter_ics_test_t85_pm_1_noise_conv_mk2_high_moisture.nc')]
...
#         'q_deep_sphum': 6.1e-3,
    ...
    #     'file_name':'INPUT/jupiter_ics_test_t85_pm_1_noise_conv_mk2_high_moisture.nc',    
    # },    
