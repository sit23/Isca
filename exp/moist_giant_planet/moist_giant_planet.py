...
exp = Experiment('moist_giant_planet_1_solar_t85_15bar_fixed_dw_source_hotter_ics_higher_opacity_new_py', codebase=cb)
...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'convection_scheme':  'SIMPLE_BETTS_MILLER', #Use the dry convection scheme of Schneider & Walker
    ...
    'fms_nml': {
        'domains_stack_size': 1228800 #Setting size of stack available to model, which needs to be higher than the default when running at high spatial resolution
    },
...
#Set parameters for dry convection scheme
    ...
    'spectral_init_cond_nml': {
        'initial_temperature':  400., #Lower than normal initial temperature
    }
