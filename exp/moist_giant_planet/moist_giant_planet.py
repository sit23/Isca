...
baseexp.namelist['fms_nml']['domains_stack_size'] = 1228800 #Setting size of stack available to model, which needs to be higher than the default when running at high spatial resolution
...
baseexp.namelist['idealized_moist_phys_nml']['convection_scheme'] = 'SIMPLE_BETTS_MILLER' #Use the dry convection scheme of Schneider & Walker
...
baseexp.namelist['surface_flux_nml']['gp_deep_water_source'] = True
# baseexp.namelist['surface_flux_nml']['flux_heat_gp'] = 0.
baseexp.namelist['surface_flux_nml']['q_deep_sphum'] = 6.1e-3
...
baseexp.namelist['constants_nml']['PSTD'] = 15.0E+06
baseexp.namelist['constants_nml']['PSTD_MKS'] = 15.0E+05
baseexp.namelist['spectral_dynamics_nml']['reference_sea_level_press'] = 15.0e5
...
baseexp.namelist['spectral_dynamics_nml']['vert_coord_option'] = 'uneven_sigma' #Use equally-spaced sigma levels
baseexp.namelist['spectral_dynamics_nml']['surf_res'] = 1.0 #Parameter for setting vertical distribution of sigma levels
...
baseexp.namelist['spectral_dynamics_nml']['initial_sphum'] = 0.0001 #No initial specific humidity
baseexp.namelist['spectral_init_cond_nml']['initial_temperature'] = 400. #Lower than normal initial temperature
...
baseexp.namelist['qe_moist_convection_nml'] = f90nml.Namelist({
    'tau_bm': 21600.,
    'rhbm':0.7,
#     'Tmin':50.,
})

exp=baseexp.derive('moist_giant_planet_1_solar_t85_15bar_fixed_dw_source_hotter_ics_higher_opacity')

exp.clear_rundir()
#Lets do a run!
exp.runmonth(1, use_restart=False,num_cores=8, light=True)
# exp.runmonth(98, num_cores=16, light=True, restart_file='/scratch/sit204/Isca/exp/moist_giant_planet/input/t85_moist_jup_97/res_213_onescript')
