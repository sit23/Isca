    ...
    for precip_timescale in [1e3, ]:
        ...
        for damping_time in [ 0.]:
            ...
            for u_deep_merid in u_deep_merid_arr:
                ...
                ld_value = 0.025
                exp = Experiment('passive_tidal_lock_0_001_delta_h_with_sp_drag_fix_gh_mk2_pb_damping', codebase=cb)
                ...
                equilibrium_geopotential = 4e5*grav
                ...
                exp.update_namelist({
                    ...
                    'shallow_physics_nml': {
                        ...
                        'h_amp_tidal_locked': 0.001*equilibrium_geopotential,
                        'showman_polvani_drag':True,
                        'do_perez_becker_damping':True,
                    },
                    'constants_nml': {
                        'omega': omega,
                        'radius': radius,
