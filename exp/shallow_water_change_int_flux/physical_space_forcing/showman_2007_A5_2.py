...
for time_avg_output in [True, False]:
    ...
    diag.add_file(outputfilename, 1, 'days', time_units='days')
...
if __name__=="__main__":
    ...
    for eta in [1e-6,1e-7,1e-8,1e-9]:
        try:
            exp = Experiment(f'showman_2007_A5_mk6_small_nu_{eta}', codebase=cb)
